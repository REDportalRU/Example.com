                    ...
                    <div class="col-lg-3-5 col-xl-4-5">
                        <div class="row form-group">
                            ...
                            <div class="col-xl-9 col-12">
                                <div class="fileupload fileupload-new mb-3"
                                    ...
                                    <div class="input-append">
                                        ...
                                        <span class="btn btn-default btn-file"
                                              v-tippy="{content: 'Загрузка главного изображения новости, которое отображается в блоках новостей', placement: 'right'}">
                                            <span class="fileupload-exists">Изменить</span>
                                            <span class="fileupload-new">Выбрать файл</span>
                                            <input v-on:input="uploadImage(form)"
                                                   multiple
                                                   required
                                                   tabindex="-1"
                                                   type="file"
...
export default {
    ...
    setup(props) {
                ...
                onFinish: visit => {
                    ...
                    if (form.hasErrors) {
                        ...
                        Func.Notify(
                            ...
                            '<span style="font-size: .90rem">Новость сохранена.</span>')
                    }
                },
            })
        }
        ...
        return {form, saveNews, getStatus}
    },
    layout: Layout
}
</script>
